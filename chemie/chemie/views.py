...
from chemie.forms import FlatpageEditForm
...
def request_funds(request):
    ...
    return render(request, "chemie/post_funds_form.html", context)
...
def edit_flatpage(request, url):
    ...
    return render(request, 'flatpages/edit_flatpage.html', context)
