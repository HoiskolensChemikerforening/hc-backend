...
from .models import Event # You need to change this if you like to add your own events to the calendar
...
register.inclusion_tag('agenda/calendar.html')(month_cal)
