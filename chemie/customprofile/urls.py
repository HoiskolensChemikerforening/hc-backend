...
urlpatterns = [
    ...
    re_path(r"^profil/aktiver/(?P<code>[a-z0-9]{32})/?", views.activate_password, name="activate"),
    path("profil/medlemmer/endre/<int:profile_id>/", views.change_membership_status, name="membership"),
