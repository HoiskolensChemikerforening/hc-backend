...
class Command(TemplateCommand):
    ...
    def handle(self, **options):
        ...
        template_dir = self.handle_template(
            options["template"], "module_template"
        )
        ...
        for root, dirs, files in os.walk(template_dir):
            ...
            for filename in files:
                ...
                new_path = path.join(
                    top_dir,
                    relative_dir,
                    filename.replace("module_name", app_name),
                )
        ...
        if self.verbosity >= 1:
            ...
            self.stdout.write(
                ...
                "to the INSTALLED_APPS setting".format(
