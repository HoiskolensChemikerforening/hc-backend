...
class TestViewsWithLargerDataBase(TestCase):
    def setUp(self):
        ...
        self.cgp = CGP.create_new_cgp()
        countries = ["1c", "2c", "3c", "4c", "5c", "6c", "7c", "8c",
                     "9c", "10c", "11c", "12c", "13c", "14c", "15c", "16c", "17c"]
        self.countrys = [Country.objects.create(country_name=c, slug=c) for c in countries]
        groups = ["1g", "2g", "3g", "4g", "5g", "6g", "7g", "8g",
                  "9g", "10g", "11g", "12g", "13g", "14g", "15g", "16g", "17g"]
        songs = ["1s", "2s", "3s", "4s", "5s", "6s", "7s", "8s",
                  "9s", "10s", "11s", "12s", "13s", "14s", "15s", "16s", "17s"]
        self.groups = [Group.objects.create(
            real_name=groups[index], country=self.countrys[index], song_name=songs[index], cgp=self.cgp
        ...
        self.groups[0].save()
        voteList = [
            [self.users[:8],   '["1c,2c,3c,4c,5c,6c,7c,8c,9c,10c,11c,12c,13c,14c,15c,16c,17c"]', 1, 2],
            [self.users[8:16], '["2c,1c,4c,3c,5c,6c,7c,8c,9c,10c,11c,12c,13c,14c,15c,16c,17c"]', 1, 2],
            [self.users[16:],  '["4c,3c,1c,2c,5c,6c,7c,8c,9c,10c,11c,12c,13c,14c,15c,16c,17c"]', 3, 4],
        ]
