...
urlpatterns = [
    ...
    path("opprett/<int:id>/", views.create_valgomat, name="valgomat_opprett_edit"),
    path("rediger/<int:id>/", views.edit_valgomat, name="valgomat_rediger"),
    path("rediger/<int:id>/slett/<int:question_id>/", views.delete_question, name="valgomat_delete_question"),
    path("rediger/<int:id>/slett/valgomat/<int:valgomat_id>/", views.delete_valgomat, name="valgomat_delete"),
]
